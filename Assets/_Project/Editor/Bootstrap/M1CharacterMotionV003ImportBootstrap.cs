...
{
    /// <summary>
    /// The production v003 sheets are generated outside Unity. On a fresh clone Unity first
    /// assigns the TextureImporter GUIDs, then this one-shot editor-load hook rebuilds the
    /// stable animation-set assets against those imported sprites before a scene can play.
    /// </summary>
    [InitializeOnLoad]
    internal static class M1CharacterMotionV003ImportBootstrap
    {
        ...
        {
            EditorApplication.delayCall += RefreshAnimationSetsWhenReady;
        }
